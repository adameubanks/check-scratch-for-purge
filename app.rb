...
# commented out lines are for testing the app locally
get '/' do
  if params['action'] == 'downloadToScratch'
    ...
    # output, error = command.exec("ls > ~/Downloads/output.txt")
